...
- **Third-Party Integrations**: AI/OCR services (e.g., Google Cloud Document AI) strictly utilize the `eu` region for data processing to comply with PDPL cross-border transfer allowances when a local `me-central-1` equivalent is unavailable.
